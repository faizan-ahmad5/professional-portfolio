        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            <div className="prose prose-lg dark:prose-invert max-w-none w-full">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed break-words text-justify">
                At Twaik, I work with tools like ArcGIS Pro, ERDAS Imagine, Google Earth Engine, along with Python and JavaScript, to analyze satellite imagery, run spatial models, and create accurate maps that guide real-world decisions. My work has ranged from flash flood and GLOF (Glacial Lake Outburst Flood) assessments to urban planning and environmental hazard mapping, all aimed at building resilience and smarter solutions.
              </p>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed break-words text-justify">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed break-words text-justify">
                In short: I&apos;m all about using geospatial intelligence to turn data into action, helping communities and organizations make informed, future-focused decisions.
              </p>
            </div>
